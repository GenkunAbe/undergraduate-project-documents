...
\definecolor{redfront}{HTML}{ffcdd2}
\definecolor{redright}{HTML}{ef9a9a}
\definecolor{redline}{HTML}{e57373}

\definecolor{bluetop}{HTML}{e0f7fa}
\definecolor{bluefront}{HTML}{b2ebf2}
\definecolor{blueright}{HTML}{80deea}
\definecolor{blueline}{HTML}{4dd0e1}

\definecolor{greentop}{HTML}{e8f5e9}
\definecolor{greenfront}{HTML}{c8e6c9}
\definecolor{greenright}{HTML}{a5d6a7}
\definecolor{greenline}{HTML}{81c784}

\definecolor{yellowtop}{HTML}{fff176}
\definecolor{yellowfront}{HTML}{ffee58}
\definecolor{yellowright}{HTML}{ffeb3b}
\definecolor{yellowline}{HTML}{fbc02d}

\definecolor{orangetop}{HTML}{fff3e0}
\definecolor{orangefront}{HTML}{ffe0b2}
\definecolor{orangeright}{HTML}{ffcc80}
\definecolor{orangeline}{HTML}{ffb74d}

\definecolor{browntop}{HTML}{efebe9}
\definecolor{brownfront}{HTML}{d7ccc8}
\definecolor{brownright}{HTML}{bcaaa4}
\definecolor{brownline}{HTML}{a1887f}

\definecolor{darkbluetop}{HTML}{e8eaf6}
\definecolor{darkbluefront}{HTML}{c5cae9}
\definecolor{darkblueright}{HTML}{9fa8da}
\definecolor{darkblueline}{HTML}{7986cb}

\definecolor{purpletop}{HTML}{f3e5f5}
\definecolor{purplefront}{HTML}{e1bee7}
\definecolor{purpleright}{HTML}{ce93d8}
\definecolor{purpleline}{HTML}{ba68c8}
